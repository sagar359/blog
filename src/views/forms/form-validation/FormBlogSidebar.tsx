...
import BlogCategory from 'src/views/forms/form-validation/BlogCategory'
...
const FormValidationBasic = () => {
  ...
  return (
    <Card>
      <CardHeader title='Blog Features' titleTypographyProps={{ variant: 'h6' }} />
      <CardContent>
        ...
        <Grid item xs={12} >
            ...
            <Controller
                ...
                <Select
                    ...
                    onChange={onChange}
                    error={Boolean(errors.select)}
                    labelId='validation-basic-selectTags'
                    aria-describedby='validation-basic-selectTags'
                >
            ...
            />
            {errors.select && (
                <FormHelperText sx={{ color: 'error.main' }} id='validation-basic-selectTags'>
                This field is required
                </FormHelperText>
            )}
            </FormControl>
                ...
                <Controller
                  ...
                  render={({ field: { value, onChange } }) => (
                    <TextField
                      ...
                      label='Permalink'
                      onChange={onChange}
                      placeholder='Blog Permalink'
                      error={Boolean(errors.blog_title)}
                      aria-describedby='validation-basic-blogPermalink'
                    />
                  )}
                />
                {errors.blog_title && (
                  <FormHelperText sx={{ color: 'error.main' }} id='validation-basic-blogPermalink'>
                    This field is required
                  </FormHelperText>
                )}
              </FormControl>
        ...
        <Grid item xs={12} >
            ...
            <Controller
                ...
                <TextField
                    ...
                    aria-describedby='validation-basic-excerpt'
                />
                )}
            />
            {errors.excerpt && (
                <FormHelperText sx={{ color: 'error.main' }} id='validation-basic-excerpt'>
                This field is required
                </FormHelperText>
            )}
            </FormControl>
